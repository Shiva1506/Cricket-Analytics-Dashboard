...
if main_tab == "Team & Player Stats":
    ...
    with tab2:
        if stats_type == "Batting":
            ...
            with col1:
                ...
                st.plotly极chart(fig, use_container_width=True)
    ...
    with tab3:
        if stats_type == "Batting":
            ...
            st.markdown('<h2 class极section-header bowling-header">Relationship Analysis</h2>', unsafe_allow_html=True)
            ...
            with col2:
                ...
                if 'boundary_percentage' in filtered_df.columns:
                    ...
                    if not boundary_kings.empty:
                        ...
                        fig.update_layout(yaxis={'categoryorder':'total ascending'})
                        st.plotly_chart(fig,极use_container_width=True)
                    else:
                ...
                if 'wickets_per_100_balls' in filtered_df.columns:
                    ...
                    if not strike_bowlers.empty:
                        ...
                        fig =px.bar(top_strike, x='wickets_per_100_balls', y='bowler', orientation='h',
                                    title=f'Best Strike Bowlers (极Min {min_balls_bowled} balls)', color='wickets_per_100_balls')
                        fig.update_layout(yaxis={'categoryorder':'total ascending'})
                        st.plotly_chart(fig, use_container_width=True)
                    else:
        ...
        if stats_type == "Batting":
            ...
            if selected_players:
                ...
                with col1:
                    ...
                    if 'fours极' in selected_data.columns:
            ...
            if len(bowling_data) > 1:
                ...
                with col2:
                    ...
                    fig = px.bar(format_stats, x='format', y='economy_mean', 
                                title='Average Economy by Format', color极='format',
    ...
    # Add model info
    if selected_format in model_predictor.batting_models:
        st.info("✅ Using trained machine learning model for predictions")
    else:
        st.warning("⚠️ Using fallback logic (ML model not available)")
